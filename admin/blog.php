            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="ekle.php?sayfa=blog">
                  <button style="float: right;" type="submit" class="btn btn-info" >Yeni blog ekle</button>
                </a>
<!--
      ...
      while ($blogcek=$blogsor->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                      <td><img style="width:150px" src="resimler/blog/<?php
                      echo $blogcek['blog_resim'] ?>"></td>
                      <td><?php echo $blogcek['blog_baslik'] ?></td>
                      

                      <td><?php echo $blogcek['blog_sira'] ?></td>
                      <td><a href="duzenle.php?sayfa=blog&id=<?php echo $blogcek['blog_id']?>"> 
                      <button type="submit" class="btn btn-success">Düzenle</button> </td>
